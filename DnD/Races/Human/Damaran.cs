...
namespace DnD
{
	public class Damaran :Human
	{
		
		public Damaran (string name,int year, string sex, int growth, int weight,AbstractClass abstractClass) : base(name,year,sex,growth,weight,abstractClass){
